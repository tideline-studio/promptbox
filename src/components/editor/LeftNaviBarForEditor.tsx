...
export const PromptList = ({
  ...
  }, [forceRenameModal, showRenameModal])
  ...
  return (
    <div>
      ...
      <input
        ...
        className='w-full px-1 py-0.5 rounded-md border border-gray-200 shadow-sm focus:border-gray-300 focus:ring focus:ring-gray-200 focus:ring-opacity-50 outline-none'
      />
    </div>
  )
}
